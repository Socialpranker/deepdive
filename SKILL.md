...
## Workflow — <!--gen:count:phases-->10<!--/gen--> фаз (1–7, включая 3.5, 3.7 и 6.5)
...
**Базовые (всегда):**
- `references/workflow.md` — детали <!--gen:count:phases-->10<!--/gen--> фаз (включая опц. 3.5) (читать в начале medium/deep).
